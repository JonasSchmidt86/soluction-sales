...
ActiveRecord::Schema.define(version: 2022_11_10_162952) do
  ...
  create_table "entrega", primary_key: "cod_entrega", id: :bigint, default: -> { "nextval('entrega_codigo_seq'::regclass)" }, force: :cascade do |t|
    ...
    t.datetime "dataassistencia"
  end

  create_table "entregas", primary_key: "cod_entregas", id: :bigint, default: nil, force: :cascade do |t|
    t.boolean "assistencia", null: false
    t.datetime "dataentrega"
    t.boolean "entregue", null: false
    t.string "observacao", limit: 255
    t.bigint "cod_pessoa", null: false
    t.bigint "cod_funcionario", null: false
    t.bigint "cod_venda", null: false
  ...
  add_foreign_key "entregas", "funcionario", column: "cod_funcionario", primary_key: "cod_funcionario", name: "pk_funcionario"
  add_foreign_key "entregas", "pessoa", column: "cod_pessoa", primary_key: "cod_pessoa", name: "fk_pessoa"
  add_foreign_key "entregas", "venda", column: "cod_venda", primary_key: "cod_venda", name: "fk_venda"
