...
ActiveRecord::Schema[7.1].define(version: 2025_05_07_194335) do
  ...
  create_table "frete", primary_key: "cod_frete", id: :bigint, default: -> { "nextval('frete_sequence'::regclass)" }, force: :cascade do |t|
    t.bigint "cod_empresa", null: false
    t.boolean "ativo"
    t.date "datacadastro"
  ...
  create_table "produtoxml", primary_key: "codigo", force: :cascade do |t|
  ...
  create_table "xml_files", force: :cascade do |t|
    ...
    t.bigint "empresa_id"
    t.bigint "compra_id"
    t.index ["compra_id"], name: "index_xml_files_on_compra_id"
