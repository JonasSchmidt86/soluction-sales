# -- update para colocar o id ordenando pela data abertura
# UPDATE caixa
#       SET id = new_id
#       FROM (
#         SELECT id, ROW_NUMBER() OVER (ORDER BY dataabertura asc, cod_empresa) AS new_id
#         FROM caixa
#       ) AS caixa_ordered
#       WHERE caixa.id = caixa_ordered.id;
