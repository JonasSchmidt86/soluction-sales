class FixEstoqueAcertoTz < ActiveRecord::Migration[7.1]
  def up
    execute <<-SQL
      CREATE OR REPLACE FUNCTION public.tgrf_estoqueacerto() RETURNS trigger LANGUAGE 'plpgsql' COST 100 VOLATILE NOT LEAKPROOF AS $BODY$
      ...
      BEGIN
          ...
          IF TG_OP = 'DELETE' THEN
              ...
              IF COALESCE(EXISTE,0) > 0 THEN
                  ...
                  VALUES (
                      ...
                      OLD.CODIGO, NULL, current_user, V_COD_FUNCIONARIO, V_ORIGEM_SISTEMA,
              ...
              ELSE
                  ...
                  VALUES (
                      ...
                      0, 0, (timezone('America/Sao_Paulo', now())::date));
          ...
          ELSE
              ...
              VALUES (
                  ...
                  QTD_ANTES, QTD_MOVIDA, (QTD_ANTES + QTD_MOVIDA),
                  NEW.CODIGO, NULL, current_user, V_COD_FUNCIONARIO, V_ORIGEM_SISTEMA,
                  CASE TG_OP
