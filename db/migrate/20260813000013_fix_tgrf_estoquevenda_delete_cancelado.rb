class FixTgrfEstoquevendaDeleteCancelado < ActiveRecord::Migration[6.1]
  def up
    execute <<-SQL
      ...
      BEGIN
          ...
          IF TG_OP = 'DELETE' THEN
              ...
              -- Se o item já foi cancelado, o estoque já foi devolvido
              -- Apenas grava log informativo e não mexe no estoque
